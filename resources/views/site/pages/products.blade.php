    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex flex-wrap gap-2">
                ...
                <a href="{{ route('site.products.category', $category->slug) }}" class="btn btn-outline-primary">{{ $category->title }}</a>
                @endforeach
            </div>
        </div>
    </div>
            ...
            <div class="col-md-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-body">
                        ...
                        @if($product->category)
                        <p class="text-muted"><small>Categoria: {{ $product->category->title }}</small></p>
                        @endif
