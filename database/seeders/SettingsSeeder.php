...
class SettingsSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $settings = [
            ...
            ['key' => 'meta_title', 'value' => 'Bem Vindos | Laminatta'],
            ...
            ['key' => 'site_name', 'value' => 'Laminatta'],
            ['key' => 'site_proprietary', 'value' => 'Laminatta LTDA'],
            ['key' => 'site_document', 'value' => '12.345.678/0001-90'],
            ['key' => 'site_email', 'value' => 'contato@laminatta.com.br'],
